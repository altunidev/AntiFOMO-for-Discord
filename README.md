...
The only file where LLM assistance was used is [`/AntiFOMO.css`](https://github.com/altunidev/AntiFOMO-for-Discord/blob/main/AntiFOMO.css), which consists of less than 50 sanely written, easily readable lines. I have personally audited and heavily tested this code. I intend to improve it by hand.

If you have issues with LLM assistance, please do the open source thing and audit the <50 lines yourself. Want something not LLM-assisted? Feel free to fork this repo and do whatever you'd like with it.
